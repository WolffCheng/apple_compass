...
function InitFloatingYoutube() {
    ...
    ytIframeList = document.getElementsByClassName("active_youtube");

    console.log("total  " + ytIframeList.length + "  videos need to be floated")
...
var Now_YT_Index = null;
function onPlayerStateChange(event) {
    console.log("------------------------------------------")
    console.log("Now_YT_Index........" + Now_YT_Index)

    for (i = 0; i < ytPlayerId.length; i++) {
        if (ytPlayerId[i].getPlayerState() === 1 && Now_YT_Index != i){
